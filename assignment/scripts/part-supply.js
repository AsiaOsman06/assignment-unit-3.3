...
let delivery = supplyChanges.push(25);
...
console.log('List of Positive Numbers: ', positives);
console.log('List of Negative Numbers: ', negatives);
console.log('List of Zero Numbers: ', zeroes);
